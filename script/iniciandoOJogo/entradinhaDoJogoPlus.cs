...
public class entradinhaDoJogoPlus : MonoBehaviour {
	...
	public NavMeshAgent CaesarNavMesh;
	public NavMeshAgent LutzNavMesh;
	public NavMeshAgent HooliganNavMesh;
	...
	void olhaPraMimPo(Transform olhe,Animator doOlhador)
	{
